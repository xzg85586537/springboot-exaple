...
import com.cn.entity.vo.RolePermissionVo;
...
public class MyInvocationSecurityMetadataSourceService implements FilterInvocationSecurityMetadataSource {
    ...
    private void loadResourceDefine() {
        ...
        List<RolePermissionVo> rolePermissionVoList = permissionMapper.getRolePermissions();

        for (RolePermissionVo rolePermissionVo : rolePermissionVoList) {
            //某个资源 可以被哪些角色访问
            String url = rolePermissionVo.getUrl();
